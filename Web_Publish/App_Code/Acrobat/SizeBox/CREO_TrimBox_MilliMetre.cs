...
namespace HanDe_ClassLibrary.Common.SizeBox
{
    public class CREO_TrimBox_MilliMetre
    {
        ...
        private MilliMetre_Unit longSide;
        /// <summary>
        /// 长边
        /// </summary>
        public MilliMetre_Unit LongSide
        {
            get { return longSide; }
        }

        private MilliMetre_Unit shortSide;
        /// <summary>
        /// 短边
        /// </summary>
        public MilliMetre_Unit ShortSide
        {
