...
namespace HanDe_ClassLibrary.PrinergyEvoFile.Preps
{
    public class TplFileInfo
    {
        ...
        /// 页面垂直占用
        /// </summary>
        private double pagePerpendicular;
        ...
        /// 实例化一个tpl文件实例
        /// </summary>
        /// <param name="tplFullPath">tpl文件的绝对路径(需要转换为pt单位的数值)</param>
        /// <param name="sheetWidth">印张宽度(需要转换为pt单位的数值)</param>
        /// <param name="sheetHeight">印张高度(需要转换为pt单位的数值)</param>
        /// <param name="pageWidth">页面宽度(需要转换为pt单位的数值)</param>
        /// <param name="pageHeight">页面高度(需要转换为pt单位的数值)</param>
        /// <param name="direction">页面方向</param>
        /// <param name="bite">咬口(需要转换为pt单位的数值)</param>
        /// <param name="horizontalType">【页面水平放置方式】居中是14,有靠身是2.</param>
        public TplFileInfo
            (string tplFullPath
            , double sheetWidth
            , double sheetHeight
            ...
            , int horizontalType)
        {
            ...
            this.TplFullPath = fileInfo.FullName;
            //模板文件名称
